...
export ROBOTWIN_LOG_ROOT=/root/TurboVLA-repro/logs/robotwin_eval_smoke_detail_v2
export POLICY_NAME=rgbd_depth8_smoke
...
bash scripts/robotwin/evaluate.sh "${checkpoint}" click_bell \
    > /root/TurboVLA-repro/logs/robotwin_eval_smoke_rgbd_20260813_v2.log 2>&1
